...
function tellFortune(numKids, partnerNames, locations, jobTitles) {
  ...
  return `You will be a ${jobs} in ${location}, married to ${partner} with ${kids} kids.`
  
}

function main() {
  const numKids = [1, 2, 3, 4, 5];
  const partnerNames = ["John", "Mary", "Mike", "Jane", "Noah"];
  const locations = ["Amsterdam", "Madrid", "Tokio", "New York", "London"];
  const jobTitles = ["Nurse", "Cloud Engineer", "DevOps", "Developer", "Data Scientist"];
